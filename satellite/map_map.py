...
def map_map(lons, lats, data,name):
...
# =============================================================================
#     c_min = 0
#     c_max = 200   #设置固定的标准进行统一化出图显示
# =============================================================================
    #cs = m.pcolormesh(x, y, data, cmap='jet', vmin=dmin, vmax=dmax)  ## contouf  pcolormesh
    #cs = plt.contourf(x, y, data, cmap='jet', vmin=dmin, vmax=dmax)
    cs = m.pcolormesh(x, y, data, cmap=cmaps.GMT_seis_r, vmin=c_min, vmax=c_max)   # GMT_panoply 
    m.colorbar(cs)   
...
# =============================================================================
    #m.drawmeridians(np.arange(120.30, 121.30, 0.2), labels=[False,True,False,True],fontsize=10)
    #m.drawparallels(np.arange(31.22, 32.02, 0.2), labels=[True,False,False,True],fontsize=10)    
