...
def getcontent():
    ...
    pm25zippath='F:\\zip\\changshu\\pm252'
    voczippath='F:\\zip\\changshu\\voc2'
    try:
    ...
    for contents in pathDir:
        ...
        for datecontents in dateDir:
            ...
            if os.path.isdir(datecontent):
                ...
                pm25shpdir="F:\\changshu\\siteetis\\pm2524\\"+datecontents[0:2]+'_'+datecontents[2:4]+'_'+datecontents[4:6]
                vocshpdir="F:\\changshu\\siteetis\\voc24\\"+datecontents[0:2]+'_'+datecontents[2:4]+'_'+datecontents[4:6]
                try:
                ...
                try:
                    ...
                    pm25zippa="F:\\changshu\\csstate\\pm2524"
                    try:
                        os.makedirs(pm25zippa)
                    except :
                        print('')
                    make_zip(pm25shpdir,pm25zippa+"\\"+PM25+".zip")
                except Exception as Error: 
                    print Error
                    '''
                try:
                    RasterToPoint_conversion(vocdir,vocPointFeatures)
                    voczippa="F:\\changshu\\csstate\\voc24"
                    try:
                        os.makedirs(voczippa)
                    except :
                        print('')
                    make_zip(vocshpdir, voczippa+"\\"+VOC+".zip")
                except Exception as Error: 
                    print Error
