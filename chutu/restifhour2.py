...
def createcontent(nowtime):
    ...
    pachongshuju ="F:\\pm1011\\ddd\\nime\\orag\\"+nowtime
    formatPath="F:\\pm1011\\ddd\\nime\\out\\"+nowtime
    inpath="F:\\pm1011\\ddd\\nime\\soiybj\\"+nowtime
...
def EBK_ga(out_file,zField,h,date):
    ...
    outFilePath="F:\\PM10\\1102\\202001"+date+"\\PM10"+getHourPath(date,h)+"\\"+zField+"\\"+"tif"
    try:
...
if __name__ == '__main__':
    ...
    for i in range(12,19):
        ...
        out_file='F:\\eidata\\200102\\1102\\PM10_'+h+'.xls'#'F:\\xiaou\\zhenli\\PM25_092905.xls'
        zField='PM10'
        arcpy.AddMessage('----------------- '+h+' ----------------')
        try:
            createcontent(getHourPath(h,"02"))
            EBK_ga(out_file,zField,h,"02")
        except:
            traceback.print_exc()
