...
def EBK_ga(out_file,zField,h):
    ...
    outFilePath="F:\\xu\\201909301811\\"+getHourPath(h)+"\\"+zField+"\\"+"tif"
    try:
...
def readCsv(file,h):
    ...
    header=[u'date',u'hour',u'type',u'1146A',u'1160A',u'1161A',u'1162A',u'1163A',u'1164A',u'1165A',u'1166A',u'1167A',u'1168A',u'1169A',u'1170A',u'1171A',u'1172A',u'1188A',u'1189A',u'1190A',u'1191A',u'1192A',u'1193A',u'1194A',u'1195A']
    rows=data[[u'date',u'hour',u'type',u'1146A',u'1160A',u'1161A',u'1162A',u'1163A',u'1164A',u'1165A',u'1166A',u'1167A',u'1168A',u'1169A',u'1170A',u'1171A',u'1172A',u'1188A',u'1189A',u'1190A',u'1191A',u'1192A',u'1193A',u'1194A',u'1195A']]
    ...
    colist=[]
    o3list=[]
    lists=np.array(lists).transpose()[3:40]
    ...
    for i in range(0,22):      
        ...
        if lists[i][5]>0:
            o3_station_data = [site[i] , lists[i][5] , Lon[i] , Lat[i]]
    ...
    # export excel
    outname = column+'_'+getHourPath(h)+'.xls'
    out_file="F:\\xiaou\\xls\\"+outname
    try:
    ...
    nt=time.strftime('%Y%m%d',time.localtime(time.time()))
    dt=time.strftime('%m%d%H',time.localtime(time.time()))
    zouhangshuju="F:\\xiaoshishuju\\"+nt+"\\"+getHourPath(h)+"\\"+column+"\\"+"xls"
    try:
...
if __name__ == '__main__':
    ...
    out_file='F:\\eightdata\\20191001\\PM25_06.xls'#'F:\\xiaou\\zhenli\\PM25_092905.xls'
    zField='PM25'
    h='06'
    arcpy.AddMessage('----------------- '+h+' ----------------')
    try:
...
'''
    for i in range(0,8):
        ...
        filepath='F:\\xiaou\\china_sites_20190929.csv'
        print '-------------------- '+formattime+' --------------------'
        try:
            os.makedirs(csvpath)
        except :
